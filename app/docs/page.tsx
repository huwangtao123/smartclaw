...
const endpoints = [
  ...
  },
  {
    method: "GET",
    path: "/api/premium",
    description: "Leaderboard metrics (top-10 by PNL & ROI)",
    auth: "None",
  },
];
...
const facts = [
  ...
  },
  {
    label: "Access",
    value: "Free",
    detail: "Public analytics endpoint",
  },
  {
    label: "Data source",
    value: "On-chain",
...
const faqs = [
  ...
  {
    q: "What does the premium API include?",
    a: "The /api/premium endpoint returns public leaderboard metrics ranked by PNL and ROI. No payment or authentication is required.",
  },
  {
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {facts.map((f) => (
              <GlassCard key={f.label} className="p-4">
                ...
                <div className="text-xl font-bold text-neon-400">{f.value}</div>
        ...
        <section className="mb-14">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                {endpoints.map((ep) => (
                  <tr key={ep.path} className="border-t border-white/[0.06]">
            ...
            <GlassCard className="p-5">
              ...
              <p className="text-xs text-white/40 leading-relaxed">
                ...
                <strong className="text-white/60">
                  f(x) Protocol leaderboard API
                </strong>
                . Data reflects cumulative on-chain positions. The leaderboard
                tracks all wallets that have interacted with f(x) Protocol
                vaults.
              </p>
            </GlassCard>
            <GlassCard className="p-5">
              ...
              <p className="text-xs text-white/40 leading-relaxed">
                ...
                <strong className="text-white/60">The Graph</strong> and
                protocol subgraphs. Historical data goes back to January 2025.
                Rates are APR (annualized percentage rate).
              </p>
            </GlassCard>
            <GlassCard className="p-5">
              <h3 className="text-sm font-semibold text-white mb-2">
              ...
              <p className="text-xs text-white/40 leading-relaxed">
                ...
                <strong className="text-white/60">every page load</strong>{" "}
                (force-dynamic). Lending rates update{" "}
                <strong className="text-white/60">daily at midnight UTC</strong>
                . Leaderboard metrics are computed in real-time per request.
              </p>
            </GlassCard>
            <GlassCard className="p-5">
              <h3 className="text-sm font-semibold text-white mb-2">
              ...
              <p className="text-xs text-white/40 leading-relaxed">
                <strong className="text-white/60">Win rate</strong> = % of
                wallets with positive PNL.{" "}
                <strong className="text-white/60">Weighted win rate</strong> = %
                of total volume from winning wallets.{" "}
                <strong className="text-white/60">Momentum</strong> = net
                capital flow share of winning wallets vs total.
              </p>
            </GlassCard>
          </div>
        </section>
        ...
        <section className="mb-14">
          ...
          <GlassCard className="p-6">
            <p className="text-sm text-white/50 mb-4">
              Copy the SKILL.md file to your AI agent&apos;s context. It
              includes endpoint details, response examples, formatting rules,
