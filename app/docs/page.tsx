...
const facts = [
    ...
    },
    {
        label: "Premium cost",
        value: "$0.01",
        detail: "fxUSD per call on Base via x402",
    },
    {
        label: "Data source",
        value: "On-chain",
...
const faqs = [
    ...
    },
    {
        ...
        a: "Premium endpoints return the top-10 traders ranked by PNL and ROI. Each call costs $0.01 fxUSD on Base network, paid automatically via the x402 payment protocol.",
    },
    {
